...
const AddProject = () => {
  ...
  const handleSnapshot = (e)=>{
    ...
    reader.onload = () => {
      ...
      setSnapshots((prevSnapshots) => [...prevSnapshots, file]);
    };
  }
  ...
  const handleAddNewProject = (e) => {
    e.preventDefault();
    console.log("woking in the sbmit");
    ...
    snapshots.forEach((snapshot) => formData.append("projectSnapshots", snapshot));
                      ...
                      {snapshots.length > 0 ? (
                        <div className="flex flex-wrap justify-center">
                          {snapshots.map((snapshot, index) => (
                            <img
                              key={index}
                              className="mx-2 h-[100px] w-[100px] text-gray-300"
